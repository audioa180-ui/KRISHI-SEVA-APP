...
class TherapyScreen extends StatefulWidget {
  final Api api;
  final String lang;
  const TherapyScreen({super.key, required this.api, required this.lang});
  @override
...
class _TherapyScreenState extends State<TherapyScreen> {
  ...
  Future<void> _send() async {
    ...
    try {
      final r = await widget.api.therapy(text, widget.lang);
      ...
      setState(() {
        msgs.add({'role': 'bot', 'text': 'Sorry, I can’t respond right now.'});
      });
    }
  }
